...
class Keyword implements KeywordInterface
{
    ...
    public function __construct($blackWordPath, $whiteWordPath)
    {
        ...
        $this->blackDictionary->backDictionary = $this->whiteDictionary;
        $this->whiteDictionary->backDictionary = $this->blackDictionary;
    }
    ...
    {
        return $this->blackDictionary->addKeyword($keyword, $this->whiteDictionary);
    }
    ...
    {
        return $this->blackDictionary->deleteKeyword($keyword, $this->whiteDictionary);
    }
    ...
    {
        return $this->whiteDictionary->addKeyword($keyword, $this->blackDictionary);
    }
    ...
    {
        return $this->whiteDictionary->deleteKeyword($keyword, $this->blackDictionary);
    }
}